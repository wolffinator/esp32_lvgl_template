...
{
    lv_obj_t * slider = (lv_obj_t *)lv_event_get_target(e);
    lv_label_set_text_fmt(slider_label, "%s", "BOO!");
    lv_obj_align_to(slider_label, slider, LV_ALIGN_OUT_TOP_MID, 0, -15);
}
...
void lv_hardware_test(void)
{
    ...
    lv_style_set_bg_color(&style1, lv_color_hex(0x7E3A6B));
    // lv_style_set_border_width(&style1, 0);
    // lv_obj_set_style_bg_color(&style1, lv_color_hex(0x7E3A6B));
    lv_obj_t * slider = lv_slider_create(lv_scr_act());
    lv_obj_set_width(slider, 120);
    lv_obj_set_pos(slider, 60, 120);
    lv_obj_set_style_bg_color(slider, lv_color_hex(0x7E3A6B), 1);
    lv_obj_set_style_border_color(slider, lv_color_hex(0x7E3A6B), 1);
    lv_obj_set_style_outline_color(slider, lv_color_hex(0x7E3A6B), 1);
    lv_obj_set_style_line_color(slider, lv_color_hex(0x7E3A6B), 1);
    ...
    lv_label_set_text_fmt(battery_label, "12%");
